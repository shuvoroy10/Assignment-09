...
const Service = () => {
  ...
  return (
    <div className="container mx-auto">
        <h2 className="text-3xl text-center font-bold mt-20">Our Winter Care Services</h2>
        <p className="text-center my-5">Ensure your pets stay warm, healthy, and comfortable throughout the chilly winter<br/> months with our range of specialized winter care services designed to meet all their needs</p>
